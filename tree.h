...
// Structure pour stocker les informations du tronçon avec le plus de fuites
typedef struct {
    char *identifiant_amont;    
    char *identifiant_aval;     
    double volume_fuite;        // Volume de fuite en valeur absolue
} PireTroncon;
